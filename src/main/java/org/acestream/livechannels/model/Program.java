    ...
    public ContentValues toContentValues() {
        ...
        if (mSeasonNumber != INVALID_INT_VALUE) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
               values.put(TvContract.Programs.COLUMN_SEASON_DISPLAY_NUMBER,Integer.toString(mSeasonNumber));
            }
        } else {
        ...
        if (mEpisodeNumber != INVALID_INT_VALUE) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                values.put(TvContract.Programs.COLUMN_EPISODE_DISPLAY_NUMBER,Integer.toString(mEpisodeNumber));
            }
        } else {
