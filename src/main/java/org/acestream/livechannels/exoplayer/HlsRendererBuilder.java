...
/**
 * A {@link ExoVideoPlayer.RendererBuilder} for HLS.
 * <p>
...
public class HlsRendererBuilder implements ExoVideoPlayer.RendererBuilder {
    ...
    private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url,
                                    ExoVideoPlayer player,CacheControl cacheControl) {
            this.context = context;
            this.userAgent = userAgent;
            this.url = url;
            this.player = player;
            ...
            playlistFetcher = new ManifestFetcher<>(url,
                    new DefaultUriDataSource(context,null, new OkHttpDataSource(ExoVideoPlayer.getDefaultOkHttpClient(), userAgent, null, null, cacheControl)), parser);
        }
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            DataSource dataSource = new DefaultUriDataSource(context, bandwidthMeter,
                    new OkHttpDataSource(ExoVideoPlayer.getDefaultOkHttpClient(), userAgent, null, bandwidthMeter, cacheControl));
            HlsChunkSource chunkSource = new HlsChunkSource(true /* isMaster */, dataSource, manifest,
                    ...
                    timestampAdjusterProvider,1000,1000);
            HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
                    MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, ExoVideoPlayer.TYPE_VIDEO);
            ...
            if (haveSubtitles) {
                ...
                HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
                        TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, ExoVideoPlayer.TYPE_TEXT);
            ...
            renderers[ExoVideoPlayer.TYPE_METADATA] = id3Renderer;
