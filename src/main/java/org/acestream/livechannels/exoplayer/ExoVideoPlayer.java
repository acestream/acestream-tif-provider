...
public class ExoVideoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *               ExoVideoPlayer#onRenderers} should be invoked once the renderers have been
         *               built. If building fails, {@link ExoVideoPlayer#onRenderersError} should be
         *               invoked.
         */
         ...
         * <p/>
         * A canceled build operation must not invoke {@link ExoVideoPlayer#onRenderers} or {@link
         * ExoVideoPlayer#onRenderersError} on the player, which may have been released.
         */
        void cancel();
    }
    ...
    static {
            ...
            sOkHttpClient = new OkHttpClient.Builder()
                            .connectTimeout(DefaultHttpDataSource.DEFAULT_CONNECT_TIMEOUT_MILLIS*4, TimeUnit.MILLISECONDS)
                            .readTimeout(DefaultHttpDataSource.DEFAULT_READ_TIMEOUT_MILLIS*2, TimeUnit.MILLISECONDS)
                            .followSslRedirects(false).followRedirects(true)
